 ...
 * with the {@code bytea} storage); Jackson transports it as base64. {@code expiresAt} is
 * empty to indicate the token never expires. {@code alias} is the user-visible label
